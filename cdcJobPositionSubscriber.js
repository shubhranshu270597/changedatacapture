...
export default class CdcJobPositionSubscriber extends LightningElement {
    ...
    handleMessage(response) {
        if (response) {
            if (response.hasOwnProperty('data')) {
                ...
                if (responsePayload.hasOwnProperty('Status__c') && responsePayload.hasOwnProperty('ChangeEventHeader')) {
                    if (responsePayload.ChangeEventHeader.hasOwnProperty('recordIds') && responsePayload.Status__c == 'Extend an Offer') {
